...
public class DButil {
    ...
    public static Connection getConnection(){
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/jpetstore?userSSL=true&useUnicode=true&characterEncoding=UTF8&serverTimezone=GMT", "root", "123456");
